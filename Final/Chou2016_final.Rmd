...
```{r Load Packages, echo=FALSE, warnings=FALSE}
library(ggplot2)
library(tidyverse)
library(knitr)
library(ggthemes)
...
describe(d2$age, na.rm=TRUE)
avg_age_high <- mean(subset(d2$age, d2$condition=='high_control'), na.rm=TRUE)
